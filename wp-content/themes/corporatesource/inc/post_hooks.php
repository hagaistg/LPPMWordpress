	...
	?>
		...
		?>
         ...
         <?php else:?>
         	...
         	<div class="blog-media <?php echo esc_attr( $formats );?>">
           		<?php if ( !is_singular() ) :?>
               		 <a href="<?php echo esc_url( get_stylesheet_directory_uri() . "/images/palceholder.png" ); ?>" class="image-popup">
                      <span class="style_1"><img src="<?php echo esc_url( get_stylesheet_directory_uri() . "/images/palceholder.png" ); ?>" alt="" /></span>
