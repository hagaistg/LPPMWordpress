...
function envo_blog_theme_stylesheets() {
	...
	// Theme stylesheet.
	wp_enqueue_style( 'envo-blog-stylesheet', get_stylesheet_uri(), array('bootstrap'), '1.1.0'  );
...
function envo_blog_theme_js() {
	...
	wp_enqueue_script( 'envo-blog-theme-js', get_template_directory_uri() . '/js/customscript.js', array( 'jquery' ), '1.0.1', true );
}
